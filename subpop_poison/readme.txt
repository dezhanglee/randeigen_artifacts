...
- subpop_no_defense: the model trained without randeigen defense.
...
For convenience (as the code takes a long time to run), we included the code outputs in the respective Python notebooks. In the last cell, the numbers below the epoch counter gives the model accuracy over clean data (ACC) and attack success rate (ASR).
